...
<body>
  ...
  <div class="imagens">
  <img src="{{ asset('/imagens/petshop_usuario_250x150.png') }}" alt="Pessoa usando software">
  <img src="{{ asset('/imagens/pessoa2.png') }}" alt="Pessoa 2">
  <img src="{{ asset('/imagens/pessoa3.png') }}" alt="Pessoa 3">
</div>
